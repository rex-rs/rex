...
def monitor_trace_logs(duration=10):
            ...
            with open("/sys/kernel/debug/tracing/trace_pipe", "r") as f:
                ...
                while time.time() - start_time < duration:
                    ...
                    if line and any(
                        ...
                        xdp_activity.append(line.strip())
                        print(f"XDP trace: {line.strip()}")
        except Exception as e:
...
def test_xdp_program():
    ...
    # Start monitoring trace logs
    print("Starting trace log monitoring...")
    xdp_activity = monitor_trace_logs(15)
    ...
    try:
        ...
        if has_activity:
            ...
            print("PARTIAL SUCCESS: XDP program loaded but no activity detected")
